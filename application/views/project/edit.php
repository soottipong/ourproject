                  ...
                  <form class="needs-validation" novalidate="" method="post" action="<?php echo site_url('projectCreate') ?>">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" value="<?php echo $result->project_name; ?>" name="project_name" required="">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" value="<?php echo $result->project_CODE; ?>" name="project_code" required="">
                          <div class="invalid-feedback">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control datepicker" name="project_date" value="<?php echo $result->project_start; ?>" required="">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control datepicker" name="project_end" value="<?php echo $result->project_end; ?>" required="">
                                <div class="invalid-feedback">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="project_location" value="<?php echo $result->project_location; ?>" required="">
                                <div class="invalid-feedback">
                                    What's forman name?
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" value="<?php echo $result->project_diameters; ?>" name="project_meters" required="">
                                <div class="invalid-feedback">
                                    What's forman name?
                                </div>
                            </div>
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="project_pile" value="<?php echo $result->project_totalpile; ?>" required="">
                                <div class="invalid-feedback">
                                    What's forman name?
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="project_depth" value="<?php echo $result->project_depth; ?>" required="">
                                <div class="invalid-feedback">
                                    What's forman name?
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                              <select class="form-control select2" name="project_status" required="">
                                ...
                                <?php echo $result->project_status; ?>
                            </div>
                      </div>
                      <div class="form-group row">
                            <label class="col-sm-1 col-form-label">Remark</label>
                            <div class="col-sm-12">
                                <textarea type="text" class="form-control" cols="30" rows="10" name="project_remark" required=""><?php echo $result->project_remark; ?></textarea>
                                <div class="invalid-feedback">
                                    What's sale name?
                                </div>
                            </div>
                    ...
                    <div class="card-footer text-right">
                      <a href="<?php echo base_url('projects/views/'.$result->id); ?>" class="btn btn-danger">Back</a>
